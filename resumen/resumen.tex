...
Mis anotaciones del ppio + corollary 8.1 + lo que sigue justo después 

\subsection{Cómo elegir clasificadores}
Lo de que vapnik chervonenkis justifica que con los datos me acerco a la verdad absoluta del mundo y del universo.
Lemma 8.2
Teorema 8.3

\section{Clase 6 (12/10)}
Cap 9 tiene Borel-catelli y eso
\end{document}